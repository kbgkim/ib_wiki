...
- **리스크 엔진 기술 사양**: [02_Risk_Engine_Tech_Spec.md](file:///home/kbgkim/antigravity/projects/ib_wiki/src/02_Integrated_IB/02_Risk_Engine_Tech_Spec.md) - 리스크 점수 정규화 및 데이터 모델.
- **통합 리스크 프레임워크**: [01_Unified_Risk_Framework.md](file:///home/kbgkim/antigravity/projects/ib_wiki/src/02_Integrated_IB/01_Unified_Risk_Framework.md) - PD/LGD/EAD 매핑 기초.
