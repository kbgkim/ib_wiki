...
-   **유동화 계획 등록**: 관련 법령에 의거 금융당국에 유동화 계획 교부 및 등록.

### Phase 3. 신용평가 및 신용보강 (Rating & Enhancement)
-   **신용평가**: 평가기관이 현금흐름 및 자산 건전성을 분석하여 증권 등급 산정.
-   **신용보강**: 높은 등급(AAA 등)을 얻기 위한 내부/외부 보강.
    -   *내부: 선/후순위 구조, 초과담보, 현금예치.*
    -   *외부: 시공사 책임준공, 금융기관 매입확약/보증.*
...
> [!IMPORTANT]
> **2024 개정 자산유동화법 반영**:
> 1. **위험보유 의무(Risk Retention)**: 자산보유자 등은 이해상충 방지를 위해 유동화증권 발행 잔액의 **5%를 의무 보유**해야 함.
> 2. **정보공개 강화**: 비등록 유동화증권도 발행 내역을 예탁결제원 **e-SAFE 시스템**에 의무적으로 공개해야 함.
...
## 3. 유동화 증권 유형 비교 (Comparison of Security Types)
...
-   **원리금 현황**: 개시원금잔액(**OPB**), 적용금리(고정/변동), 이자계산방식(Day count).
-   **담보/건전성**: 부동산 소재지, 담보 설정액(근저당), 감정평가액, 최신 **LTV**, 연체 여부, 조기상환 수수료.
...
---
*참조: ABS Basics, Risk Engine Tech Spec*
