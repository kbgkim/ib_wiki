...
자산유동화(ABS)는 부동산, 매출채권, 주택담보대출 등 유동성이 낮은 자산을 기초로 증권(Securities)을 발행하여 자산 보유자가 자금을 조달하는 금융 기법입니다.
...
### IMPORTANT: 신용 보강 (Credit Enhancement)
위 예시에서 후순위와 중순위가 차지하는 20%의 두께가 선순위 투자자에게는 '20%의 손실까지는 내 원금이 안전하다'는 확신을 주는 핵심 장치가 됩니다.

### ─────────────

## ⚙️ 3. 실무적 확장: 만기별 순차 상환 (Sequential Pay)
...
- **부도 시 손실률 (LGD)**: 선순위는 극히 낮으며, 후순위는 거의 100%에 수렴합니다.
