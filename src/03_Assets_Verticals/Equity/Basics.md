...
## 2. 주요 투자 상품군 (Product Types)

비상장 주식 및 사모펀드 딜에서는 주식과 채권의 성격을 결합한 메자닌 상품이 널리 사용됩니다.

| 상품명 | 영문명 | 핵심 특징 |
| :--- | :--- | :--- |
| **상환전환우선주** | **RCPS** | 배당 우선권 + 원금 상환권 + 보통주 전환권 결합 (투자자 유리) |
| **전환사채** | **CB** | 채권으로 보유하다가 주가 상승 시 주식으로 전환 가능 |
| **신주인수권부사채** | **BW** | 채권 원금은 유지하면서 별도의 신주 인수 권리(Warrant) 행사 |

### 비상장 딜 라이프사이클
비상장 주식의 발굴부터 북킹, 사후 관리까지의 상세 프로세스는 **[비상장 주식 딜 라이프사이클 및 북킹 가이드](Unlisted_Deal_Lifecycle.md)**에서 상세히 다룹니다.

## 3. 기업 가치평가 (Valuation Triangulation)
