...
> [!NOTE]
> **K-IFRS 회계 처리 주의**: RCPS/CB는 발행 조건(상환 의무 존재 여부 등)에 따라 **부채** 또는 **자본**으로 분류가 달라집니다. 특히 전환가액 조정(Refixing) 조항이 있는 경우 '확정금융채무' 성격이 강해져 부채로 분류될 가능성이 높습니다.
...
비상장 주식은 상장 주식에 비해 정보 비대칭성이 크고 거래량이 적으므로, **유동성 할인(Illiquidity Discount)**을 반영한 보수적 밸류에이션이 필수적입니다. 할인율(**WACC**)과 영구성장률(**g**)에 따른 기업 가치 변화 예시입니다. (단위: 억 원)
