...
-   **상계처리 (**`Off-set`**)**: 유입 시 본인이 배당받을 금액을 제하고 차액만 법원에 납부.
    -   **법적 근거**: 민사집행법 제143조 2항 (차액지급신고).
    -   **신청 기한**: 매각결정기일이 끝날 때까지 신고서 제출 필수.
...
> [!TIP]
> **질권 대출 (Pledge Loan) 활용**: NPL 채권을 매입한 후 해당 채권 자체를 담보로 금융기관에서 대출을 받아 경매 입찰 및 잔금 납입 자금을 마련하는 것이 실무상 표준화된 브릿지 펀딩 기법입니다.
