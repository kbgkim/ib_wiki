...
| 평가 등급 | 정의 | 사후관리 조치 |
| :--- | :--- | :--- |
| **양호 (Good)** | 사업 계획대로 원활히 진행 중 | 정상 지원 / 만기 연장 |
| **보통 (Normal)** | 일부 지연이 있으나 사업성 유지 | 자율적 재구조화 유도 |
| **유의 (Caution)** | 사업성이 저하되어 부실화 가능성 농후 | **재구조화 및 자율매각** 추진 |
| **부실우려 (Risk)** | 회수 가능성이 매우 낮음 | **경/공매**를 통한 조기 정리 |
