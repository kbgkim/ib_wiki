...
> [!NOTE]
> PF 리스크는 특정 임계점(Threshold) 통과 시 전이 속도가 빨라지므로 [리스크 전파 매커니즘](../../02_Integrated_IB/03_Risk_Propagation_Mechanics.md) 연구가 필수적입니다.
...
- **리스크 전파 매커니즘**: [03_Risk_Propagation_Mechanics.md](../../02_Integrated_IB/03_Risk_Propagation_Mechanics.md) - 비선형 충격 전이 모델.
