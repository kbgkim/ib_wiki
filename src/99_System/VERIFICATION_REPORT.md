...
2024~2025년 최신 규제 및 실무 관행을 바탕으로 전 자산군 가이드를 전수 조사하여 보완 조치하였습니다.

| 영역 | 검토 항목 | 결과 | 상세 조치 내용 |
| :--- | :--- | :---: | :--- |
| **Equity** | 대주주 양도세 및 RCPS 회계 | **PASS** | 대주주 요건(4%, 50억) 및 세율 세분화, K-IFRS 자본/부채 분류 기준 반영. |
...
| **Common** | 수수료 표준화 및 용어 | **PASS** | 금감원 PF 수수료 11개 표준화 반영, OPB/OP 용어 정합성 확인. |
